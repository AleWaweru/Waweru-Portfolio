...
```
  cd my-folder
  git clone git@github.com:AleWaweru/Waweru-Portfolio.git
...
I would like to thank the amaizing team of developers who encouraged to me to build this project.
